...
export class MainView extends LitElement {
    ...
    constructor() {
        ...
        this._whisperModel = 'Xenova/whisper-base';
    ...
    async _loadFromStorage() {
        try {
            ...
            this._whisperModel = prefs.whisperModel || 'Xenova/whisper-base';
    ...
    triggerApiKeyError() {
        // Only BYOK has an API-key field; local and chatgpt have none.
    ...
    _renderByokMode() {
        return html`
            ...
            <div class="mode-links">
                ...
                <button class="mode-link" @click=${() => this._saveMode('chatgpt')}>Use ChatGPT subscription</button>
            </div>
        `;
    }
    ...
    _renderChatGptMode() {
        return html`
            <div class="form-group">
                <div class="form-hint">
                    Uses your ChatGPT Plus/Pro subscription through your signed-in OpenAI account — no API
                    key required.
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="form-hint">
                    Connect your ChatGPT account in Settings before starting a session. The Connect button
                    lives there under "ChatGPT subscription (OpenAI)".
                </div>
            </div>
    ...
    render() {
        ...
        return html`
            <div class="form-wrapper">
                ...
                ` : this._mode === 'chatgpt' ? html`
                    <div class="page-title">
                        ${html`Cheating Daddy <span class="mode-suffix">ChatGPT</span>`}
                    </div>
                ` : html`
                    <div class="page-title">
                ...
                ${this._mode === 'chatgpt' ? this._renderChatGptMode() : ''}
